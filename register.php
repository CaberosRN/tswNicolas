...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit'])) {
    ...
    if ($query->rowCount() > 0) {
        ...
        if (count($errors) == 0) {
            $insertQuery = $pdo->prepare("INSERT INTO users (name, lastname, email, password, rol) VALUES (?, ?, ?, ?, ?);");
            $result = $insertQuery->execute([$fullname, $lastname, $email, $password_hash, 'user']);
                            ...
                            <form class="user" action="" method="post">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" name="name" class="form-control form-control-user" id="exampleFirstName" placeholder="Nombre" require>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="text" name="lastname" class="form-control form-control-user" id="exampleLastName" placeholder="Apellidos" require>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control form-control-user" id="exampleInputEmail" placeholder="Correo Electronico" require>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="password" name="confirm_password" class="form-control form-control-user" id="exampleRepeatPassword" placeholder="Confirmar Contraseña" require>
                                    </div>
                                </div>
                                <div class="form-group">
